              ...
              <div className="apply-form card no-hover">
                <form action="#">
                  ...
                  <div className="form-group">
                    ...
                    <small className="form-text mt-2">
                      Enter the amount you need to deliver your game (e.g.
                      "$100k")
                    </small>
                  </div>
                  <div className="form-group">
                    <label htmlFor="description">
                      Describe your game assets you are going to pre-sell as
                      NFTs
                    </label>
                    <textarea
                      id="description"
                  ...
                  <div className="form-group">
                    ...
                    <small className="form-text mt-2">
                      Add a game demo video, or a link to screenshots or
                      artworks
                    </small>
                  </div>
                  <div className="form-group">
                  ...
                  <span className="d-inline-block">
                    {this.state.initData.notice}
                  </span>
                  <button
                    type="submit"
                    className="btn btn-bordered active mt-4"
                  >
                    {this.state.initData.btn} <i className="icon-login ml-2" />
                  </button>
                </form>
              </div>
            </div>
